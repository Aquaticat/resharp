/// Usage:
///   cargo run --example build_byte_freq -- [corpus_path] [output_path]
///
/// Defaults:
...
///   cargo run --example build_byte_freq -- /mnt/g/repos/rust \
...
fn generate_source(counts: &[u64; 256]) -> String {
    ...
    out.push_str(
        "// Auto-generated by `cargo run --example build_byte_freq -- <corpus_path>`.\n\
